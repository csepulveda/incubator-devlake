...
func makePipelinePlanV200(
	subtaskMetas []plugin.SubTaskMeta,
	scopeDetails []*srvhelper.ScopeDetail[models.ClickUpScope, models.ClickUpScopeConfig],
...
func makeScopesV200(
	...
	for _, scopeDetail := range scopeDetails {
		...
		// Create board domain layer entity
		domainBoard := &ticket.Board{
			DomainEntity: domainlayer.DomainEntity{
				Id: didgen.NewDomainIdGenerator(&models.ClickUpScope{}).Generate(connection.ID, scope.Id),
			},
			Name: scope.Name,
		}
